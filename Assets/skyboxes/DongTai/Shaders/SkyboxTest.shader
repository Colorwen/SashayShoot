...
Shader "MADFINGER/Environment/Scroll 2 Layers Multiplicative - SkyboxTest" {
Properties {	
		...
		_AMultiplier1 ("Layer Multiplier", Float) = 0.5
		_AMultiplier2 ("Layer Multiplier", Float) = 0.5
}
...
SubShader {
	...
	{		
		...
		o.color = fixed4(_AMultiplier, _AMultiplier1, _AMultiplier2, 1);
